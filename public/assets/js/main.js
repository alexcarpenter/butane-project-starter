...
exports.default = function () {
  ...
  var normal = new _fontfaceobserver2.default('Source Sans Pro', {
    weight: 'normal',
    style: 'normal'
  });

  var italic = new _fontfaceobserver2.default('Source Sans Pro', {
    weight: 'normal',
    style: 'italic'
  });

  var semibold = new _fontfaceobserver2.default('Source Sans Pro', {
    weight: '700',
    style: 'normal'
  });

  Promise.all([normal.load(), italic.load(), semibold.load()]).then(function () {
    document.documentElement.className += ' fonts-loaded';
...
var _fontLoading = __webpack_require__(0);

var _fontLoading2 = _interopRequireDefault(_fontLoading);

var _offline = __webpack_require__(1);
